...
if (isset($_POST['simpan'])) {
    ...
    //memindahkan file gambar yang diunggah ke direktori tuujuan
    if (move_uploaded_file($_FILES ["image"]["tmp_name"], $imagePath)) {
        //jika postingan berhasil, masukkam data postingan ke dalam database
        $query = "INSERT INTO posts (post_title, content, created_at, category_id, user_id, image_path) VALUES ('$postTitle, '$content', NOW(), $category_Id, $userId, $imagePath)";
        ...
        $_SESSION['notification'] =['type' => 'danger', 'message' => 'Failed to upload image.'];
    }
